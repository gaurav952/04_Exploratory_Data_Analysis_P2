...
barplot(coal_emiss$total, names.arg = c("1999", "2002", "2005", "2008"), ylab = "Emissions PM2.5 (tons)", xlab = "Year", col = "magenta", main = "USA Total Emissions (PM 2.5) Coal-Combustion Related Sources")
